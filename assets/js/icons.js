...
(function () {
  ...
  var ICONS = {
    ...
    activity: '<svg viewBox="0 0 24 24" ' + A + '><path d="M3 12h4l2.5-7 4 14L16 12h5"/></svg>',
    star: '<svg viewBox="0 0 24 24" ' + A + '><path d="m12 3 2.7 5.6 6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1L3.2 9.5l6.1-.9z"/></svg>',
